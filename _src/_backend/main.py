...
class Design(Color_code, Color):
    def __init__(self, hex_code, name):
        # Initialize both parent classes
        Color_code.__init__(self, hex_code)
        Color.__init__(self, name)

    def get_design_properties(self):
        return f"Hex Code: {self.color_properties()}, Name: {self.color_name()}"

# Example usage
# color_object = Color_code("ffccff")
# print(color_object.color_properties())  # Output: ffccff

design_object = Design("ff00ff", "Magenta")
print(design_object.get_design_properties())  # Output: Hex Code: ff00ff, Name: Magenta
